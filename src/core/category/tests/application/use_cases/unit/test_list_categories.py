...
class TestListCategories:
    ...
    def category_movie(self) -> Category:
        return Category(name="Filmes", description="Categoria de filmes")

    @pytest.fixture
    def category_series(self) -> Category:
        return Category(name="Séries", description="Categoria de séries")
    ...
    def mock_populated_repository(
        ...
        repository = create_autospec(CategoryRepository)
        repository.list.return_value = [category_movie, category_series]
        return repository
